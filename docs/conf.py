# -*- coding: utf-8 -*-
#
# pytest-splunk documentation build configuration file, created by
...
project = u'pytest-splunk'
copyright = u'2015, Mark Shao'
author = u'Mark Shao'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-splunk Documentation',
     [author], 1)
]
